...
// Wallet signer comes from your dApp connector (e.g. @perawallet/connect)
import { PeraWalletConnect } from "@perawallet/connect";

// Init wallet connector
...
type Chain = "arbitrum" | "mantle-sepolia" | "sonic" | "sepolia" | "core" | "monad";
...
const RPC_URL_MAP: Record<Chain, string> = {
  ...
  core:"https://rpc.test.btcs.network/",
...
const EXPLORER_URL_MAP: Record<Chain, string> = {
  ...
  core: "https://scan.test.btcs.network/",
